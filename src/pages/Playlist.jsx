...
function Playlist() {
  ...
  return (
    <div className='w-full h-[100vh] bg-black flex justify-start items-center flex-col pt-[20px] md:pt-[100px] gap-[30px]'>
      ...
      {!songs.length < 1 ? <><h1 className='text-neon-yellow font-semibold text-[24px] border-b border-gray-800 pb-2 w-[90%] md:w-[80%] pl-2'>Your Playlist</h1>
        ...
        :
        <div className='text-gray-700 text-[30px] text-semibold'>No Songs In playlist</div>
      }
